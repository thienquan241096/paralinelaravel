                            ...
                            <div class="card-header">
                                <div class="card-tools">
                                    <div class="input-group input-group-sm" style="width: 150px;">
                                        <input type="text" name="search" id="search" data-url="{{ route('backend.admin.permissions.search') }}" class="form-control float-right" placeholder="Search">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table table-hover text-nowrap">
                                    ...
                                    <tbody id="search-data">
                                            @include('backend.admin.permissions.search')
                                    </tbody>
                                </table>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <div class="dataTables_paginate paging_simple_numbers float-right" id="example2_paginate">
                            @include('backend.components.pagination', ['paginator' => $permissions])
                        </div>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
